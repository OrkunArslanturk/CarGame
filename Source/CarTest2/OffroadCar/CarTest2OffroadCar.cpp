...
#include "CarTest2OffroadCar.h"
#include "CarTest2OffroadWheelFront.h"
#include "CarTest2OffroadWheelRear.h"
...
ACarTest2OffroadCar::ACarTest2OffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCarTest2OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCarTest2OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCarTest2OffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCarTest2OffroadWheelRear::StaticClass();
